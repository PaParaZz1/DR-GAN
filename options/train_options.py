...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr_G', type=float, default=0.0001, help='initial learning rate of Generator')
        self.parser.add_argument('--lr_D', type=float, default=0.0001, help='initial learning rate of Discriminator')
        self.parser.add_argument('--count_epoch', type=int, default=370, help='the starting count epoch count')
        ...
        self.parser.add_argument('--w_L1', type=int, default=1.5, help='the weight of the L1 loss')
